...
export default function About() {
  return (
    <section className='max-w-[944px] flex items-center justify-center border-gray-100 dark:border-gray-900 border-b-2 pb-12 pt-12'>
      <div className='px-4 flex-col items-center justify-center '>
        <Title title='About' />
        <p className='pt-2 flex-col text-gray-500 text-lg'>
          <span>
